    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thesis', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='thesis_votes', to='theses.Thesis')),
            ],
            options={
                'verbose_name': 'głos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thesis', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='thesis_remarks', to='theses.Thesis')),
            ],
            options={
                'verbose_name': 'uwaga',
