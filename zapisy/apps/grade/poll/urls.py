...
urlpatterns = [
    ...
    url(r'^(?P<semester>[\d]*)/poll_results/(?P<mode>[S,T])(?P<poll_id>[1-9][0-9]*)?$',
        views.poll_results, name='grade-poll-poll-results-semester'),
    ...
    url(r'^managment/poll/edit/form/(?P<poll_id>[1-9][0-9]*)/$',
        views.poll_edit_form, name='grade-poll-poll-edit-form'),
    ...
    url(r'^managment/templates/show/(?P<template_id>[1-9][0-9]*)/$',
        views.show_template, name='grade-poll-show_template'),
